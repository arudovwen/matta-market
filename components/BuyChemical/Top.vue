<template>
  <div class="container pt-[96px] pb-6   ">
    <h1 data-aos="fade-in"
      data-aos-once="true" class="text-4xl md:text-6xl font-semibold mb-6 max-w-[730px]">
      Source your {Chemicals} all in one place
    </h1>
    <p data-aos="fade-in"
      data-aos-once="true" class="text-lg md:text-xl mb-12 max-w-[640px] text-[#475467]">
      Search products. Request samples. Request quotes. Explore flexible payment
      options. Enjoy fast delivery.
    </p>

    <div data-aos="fade-in"
      data-aos-once="true" class="flex gap-x-4 mb-[64px]">
    ...
    <div data-aos="fade-up"
      data-aos-once="true" class="top_image h-[200px] xl:h-[516px]  w-full"></div>
  </div>
</template>
<style scoped>
