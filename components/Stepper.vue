<template>
  ...
  >
    <div
      ...
      class="relative after:content-[''] after:absolute after:border-b-2 after:border-[#EAECF0]  after:w-[120px] after:top-1/2 after:translate-y-[-50%] after:left-[27px] after:last:content-none after:z-10"
      :class="`${
        active > tab.value
      ...
      >
        <span class="bg-white" v-if="active > tab.value">
          <AppIcon
            ...
            iconClass="text-[28px] text-primary-500"
        /></span>
        ...
        >
          <span
            class="bg-[rgba(34,112,250,0.25)] rounded-full flex items-center h-[28px] w-[28px] justify-center absolute z-[1]"
          ></span>
  ...
  >
    <div
      ...
      :key="tab.value"
      @click="selectValue(tab.value)"
      class="cursor-pointer relative after:content-[''] after:border-primary-500 after:absolute after:border-b-2  after:w-32 after:top-1/2 after:translate-y-[-50%] after:left-[14px] after:last:content-none after:z-10"
    >
      <span
        class="flex flex-col justify-center gap-y-1 z-20 relative items-center"
      >
