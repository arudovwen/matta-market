<template>
  ...
  >
    <div
      ...
      class="relative after:content-[''] after:absolute after:border-b-2 after:border-[#EAECF0]  after:w-32 after:top-1/2 after:translate-y-[-50%] after:left-[14px] after:last:content-none after:z-10"
      :class="`${
        active > tab.value
