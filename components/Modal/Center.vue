  ...
  <TransitionRoot as="template" :show="isOpen">
    ...
    >
      ...
      >
        ...
        >
          <div  :class="className"
            class="inline-block relative align-bottom bg-white rounded-lg text-left invisible-scrollbar shadow-xl transform transition-all sm:my-8 sm:align-middle w-full max-w-[500px] max-h-[95vh]"
